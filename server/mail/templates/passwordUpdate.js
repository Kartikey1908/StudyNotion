        ...
        <body>
            <div class="container">
                ...
                <div class="body">
                    <p>Hey ${name},</p>
                    <p>
                        Your password has been successsfully updated for the email <span class="highlight">${email}</span>.
                    </p>
                    <p>If you did not request this password change, please contact use immediately to secure your account.</p>
                </div>
                <div class="support">
